    ...
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                ...
                <b style="font-size: 75px fonts:">SHADOW REALM</b>
                <div class="table100">
                        <img style="margin: 10px"src="https://vignette.wikia.nocookie.net/evil/images/5/54/The_Shadow_Realm.jpg/revision/latest?cb=20180405180010" height="180" width="180"></div>
...
$sql = "SELECT * FROM `websitex`.`character`, `websitex`.`region` WHERE `region`.`name` = 'shadowRealm' and `region`.`name` = `character`.`region`";
