      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                   ...
                   <td><?php echo  "<a href = 'profileforadmin.php?URL={$row['url']}'> {$row['username']}</a>";?></td>
                    ...
                    <td><a href='deleteAction.php?username=<?php echo $row['username']?>' style='width:20px;height:20px;' src='http://www.newdesignfile.com/postpic/2013/10/letter-x-icon_293201.png' name='foo' id='button' value='bar'>Delete</a></td>
